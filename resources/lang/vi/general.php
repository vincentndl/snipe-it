<?php
    ...
    'action'                => 'Tác vụ',
    'activity_report'		=> 'Báo cáo tác vụ',
    'address'				=> 'Địa chỉ',
    'admin'					=> 'Quản trị',
    'administrator'			=> 'Quản trị viên',
    'add_seats'             => 'Thêm chỗ/dòng',
    ...
    'bulk_checkout'  		=> 'Bàn giao số lượng lớn',
    'cancel'  				=> 'Hủy',
    'categories'			=> 'Danh mục',
    'category'				=> 'Thể loại',
    'change' 		        => 'Vào / ra',
    ...
    'checkout'  			=> 'Bàn giao',
    'checkouts_count'       => 'Bàn giao tài sản',
    'checkins_count'        => 'Thu hồi tài sản',
    ...
    'dashboard'				=> 'Trình điều khiển',
    'days'      			=> 'ngày',
    'days_to_next_audit'    => 'Ngày kiểm tra tiếp theo',
    'date'					=> 'Ngày',
    'debug_warning'         => 'Cảnh báo!',
    'debug_warning_text'    => 'Ứng dụng này đang chạy trong chế độ bật gỡ lỗi. Điều này có thể phơi bày dữ liệu nhạy cảm nếu ứng dụng của bạn có thể tiếp cận được với thế giới bên ngoài. Tắt chế độ gỡ lỗi bằng cách đặt giá trị <code>APP_DEBUG</code> trong tệp <code>.env</code> của bạn thành <code>false</code>.',
    'delete'  				=> 'Xóa',
    'delete_confirm'  		=> 'Bạn có chắc chắn muốn xoá trường này không?',
    'deleted'  				=> 'Đã xóa',
    'delete_seats'  		=> 'Chỗ/Dòng đã xóa',
    ...
    'language'				=> 'Ngôn ngữ',
    'last'					=> 'Cuối',
    'last_login'            => 'Lần đăng nhập cuôi',
    'last_name'             => 'Tên',
    'license'				=> 'Bản quyền',
    ...
    'users'                 => 'Người dùng',
    'viewassets'  			=> 'Xem các tài sản đã bàn giao',
    'website'               => 'Website',
